...
4. **Création des géométries**, en deux phases :
   - **Volet A — documents non significatifs, communes RNU et trous de couverture** : récupération automatique de la géométrie de contour administratif (commune ou EPCI), sans relecture manuelle.
...
5. **Rédaction des messages** associés aux occurrences validées des documents significatifs (génération par LLM, validation humaine, vérification orthographique) — inclut aussi les messages fixes des documents non significatifs, des communes RNU et des trous de couverture.
